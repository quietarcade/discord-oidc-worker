...
A Discord OIDC provider for Cloudflare Access, based on [Erisa/discord-oidc-worker](https://github.com/Erisa/discord-oidc-worker). Rebuilt with environment-based configuration, role-based admin detection, and richer user profile claims.
